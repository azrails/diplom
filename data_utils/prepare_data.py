...
def prepare_dataset(dataset, splits, output_dir, generate_mask=False):
    ...
    for split in splits:
        ...
        print('Processing split:{} - Len: {}'.format(split, 1 if not isinstance(ref_ids, list) else len(ref_ids)))
...
def get_split(args):
    """
    Getting splits partitions for some dataset
    """
